...
import {fetchStatisticData} from "../store/actions/statistic";
  ...
  return (
    <div className="mt-10 container mx-auto">
      ...
      <div className="my-10 flex">
        <button
          className="bg-red-500 inline-flex items-center justify-center text-white px-4 py-1 rounded tracking-wide firago-medium-upper font-display focus:outline-none focus:shadow-outline hover:bg-red-600 shadow-lg ring ring-transparent focus:ring-red-500/20 disabled:opacity-75 disabled:hover:bg-red-500 disabled:cursor-not-allowed"
          onClick={() => changeLanguage('en')}>English
        </button>
        <button
          className="bg-red-500 inline-flex items-center justify-center text-white px-4 py-1 ml-2 rounded tracking-wide firago-medium-upper font-display focus:outline-none focus:shadow-outline hover:bg-red-600 shadow-lg ring ring-transparent focus:ring-red-500/20 disabled:opacity-75 disabled:hover:bg-red-500 disabled:cursor-not-allowed"
          onClick={() => changeLanguage('ka')}>ქართული
        </button>
      </div>
